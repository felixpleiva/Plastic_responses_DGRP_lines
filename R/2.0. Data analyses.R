# Script to analyse data from the MS:
# 
# Phenotypic responses of body size and cell size to oxygen and temperature
# in Drosophila melanogaster
# 
# Data generated by Félix P Leiva, Radboud University, the Netherlands
# Script created by Félix P Leiva 20210715
# ------------------------------------------------------------------------------
...
setwd("C:/Users/Invunche/Dropbox/Radboud University/publicaciones/Thesis/10. Evolution of cell size/outputs")
# check directory
getwd()
# ------------------------------------------------------------------------------
#Libraries
...
# ------------------------------------------------------------------------------
# load data
dat<-read.csv("body size traits after one generation of development ( 20210714 ).csv")
# ------------------------------------------------------------------------------
...
#add  missing treatment from 25°C and 21 kPa (Chapter 4)
